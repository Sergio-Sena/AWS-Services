/**
 * S3 Explorer - Backend Server
 * 
 * Este arquivo contém o servidor Express que fornece a API para o S3 Explorer.
 * Ele inclui rotas para autenticação, listagem de buckets, listagem de objetos,
 * download de objetos, criação de buckets e upload de arquivos.
 */
 ...
 * Retorna todos os buckets disponíveis para as credenciais fornecidas
 */
 ...
 * Retorna os objetos e "pastas" (prefixos) em um bucket específico
 */
 ...
 * Permite fazer download de um objeto específico de um bucket
 */
 ...
 * Cria um novo bucket S3 com o nome e região especificados
 */
 ...
 * Permite fazer upload de múltiplos arquivos para um bucket específico
 */
